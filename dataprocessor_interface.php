<?php
/**
 * Interface untuk pemilihan prosesor dataset
 * File dataset disimpan di folder /dataset
...
class DataprocessorFactory
{
    ...
    {
        $processorTypes = [
            ['dataset' => 'agile_ziauddin', 'processingData' => new AgileZiauddinProcessor],
            ['dataset' => 'cocomo_nasa93', 'processingData' => new CocomoNasa93Processor],
            ['dataset' => 'ucp_silhavy', 'processingData' => new UCPSilhavyProcessor],
